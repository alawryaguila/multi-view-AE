...
class ListDataModule(pl.LightningDataModule):
    """LightningDataModule for multi-view data.
    ...
    def setup(self, stage):
        ...
        if self.is_validate:
            ...
            self.train_dataset = hydra.utils.instantiate(self.dataset, data=[train_data]) 
            self.test_dataset = hydra.utils.instantiate(self.dataset, data=[test_data])
        else:
            self.train_dataset = hydra.utils.instantiate(self.dataset, data=[self.data], labels=self.labels) 
            self.test_dataset = None
